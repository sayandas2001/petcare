...
<!-- Carousel Start -->
 ...
 <div class="container-fluid p-0">
      ...
      <!-- <div class="container-fluid bg-light pt-5 pb-4"> -->
        ...
        <?php foreach($allcost as $value) {?>
            <div class="d-flex flex-column text-center mb-5">
                <h4 class="text-secondary mb-3"><?php echo $value->title;?></h4>
                <h1 class="display-4 m-0"><h1 class="<?php echo $value->price;?>"></h1>
                <p><?php echo $value->description; ?></p>
                <a href="<?php echo $value->link;?>" class="btn btn-lg btn-primary mt- mt-md-4 px-4" target="_blank"> sign  Now</a>             
               </div>
    ...
    <?php foreach($allbook as $value): ?>
        <div class="d-flex flex-column text-center mb-5">
            <h4 class="text-secondary mb-3"><?php echo $value->name; ?></h4>
            <h1 class="display-4 m-0"><?php echo $value->email; ?></h1>
