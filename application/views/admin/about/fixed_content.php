...
<div class="main-content-inner">
   <div class="row">
      <div class="col-12 mt-5">
         ...
         <div class="card">
            <div class="card-body">
                <form name="myForm" id="contact" method="post" action="<?php echo admin_url() ?>about/fixedcontentedit" role="form" enctype='multipart/form-data'>
                    <input type="hidden" value="<?php echo $aboutcontent->id; ?>" name="id" id="id" />
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php if(!empty($aboutcontent->image)) { ?>
                                            <img src="<?php echo base_url('uploads\about\original/'.$aboutcontent->image); ?>" width="150" height="100">
                                        <?php } else { ?>
                            ...
                            <input class="form-control" type="text" name="description" id="description" value="<?php echo $aboutcontent->description; ?>">
                        </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
